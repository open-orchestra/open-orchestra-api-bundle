...
namespace OpenOrchestra\BaseApiBundle\Tests\Functional\Mapping\Reader;
...
class SearchMappingReaderTest extends KernelTestCase
{
    ...
    public function setUp()
    {
        ...
        static::bootKernel();
        $this->readerSearch = static::$kernel->getContainer()->get('open_orchestra_api.annotation_search_reader');
    }
